 ...
 * @since 2022/6/16
 */
class A_AnimatorSetPlaySequentiallyViewGroup @JvmOverloads constructor(
    ...
    init {
        inflate(context, R.layout.layout_animatorset_playsequentially, this)
...
//                    repeatCount = ValueAnimator.INFINITE
            ...
            AnimatorSet().apply {
                playSequentially(tv1BgAnimator, tv1TranslationX, tv2TranslationX)
                duration = 1000L
                start()
            }
        }
