 ...
 * @date 7/15/20
 */
public class I_ReverseEvaluatorViewGroup extends LinearLayout {
    private static final String TAG = "C_ValueAnimatorVarArgsV";
    private final TextView tv;

    public I_ReverseEvaluatorViewGroup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        inflate(context, R.layout.i_reverse_evaluator_viewgroup, this);
