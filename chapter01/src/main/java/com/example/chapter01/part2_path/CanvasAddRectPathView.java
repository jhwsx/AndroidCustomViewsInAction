 ...
 * @since 20-3-8
 */
public class CanvasAddRectPathView extends View {
    public CanvasAddRectPathView(Context context) {
        super(context);
    }

    public CanvasAddRectPathView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CanvasAddRectPathView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
