...
/**
 * 色彩反转就是求出每个色彩的补值来作为目标图像的对应颜色值。
 * @author wangzhichao
 * @since 2022/5/31
 */
class D_ColorMatrixInvertView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText("反相的图片：", 0f, -fontMetrics.top  * 2 + avatarSize + 20.dp, textPaint)
