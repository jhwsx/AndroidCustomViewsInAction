 ...
 * @date 2019/09/26
 */
class B_InvertedImageView_DSTIN(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    init {
        ...
        srcBitmap = BitmapFactory.decodeResource(resources, R.drawable.dog_invert_shade)
        val matrix = Matrix()
        matrix.postScale(1f, -1f)
        dstBitmap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.width, bitmap.height, matrix, true)
    }
