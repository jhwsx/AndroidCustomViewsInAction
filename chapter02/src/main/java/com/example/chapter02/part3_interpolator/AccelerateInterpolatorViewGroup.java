 ...
 * @since 20-4-9
 */
public class AccelerateInterpolatorViewGroup extends ConstraintLayout {
    public AccelerateInterpolatorViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        inflate(context, R.layout.accelerate_interpolator_viewgroup, this);
