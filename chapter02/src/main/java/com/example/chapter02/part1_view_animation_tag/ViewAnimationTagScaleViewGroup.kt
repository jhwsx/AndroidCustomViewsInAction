 ...
 * @since 20-3-24
 */
class ViewAnimationTagScaleViewGroup(context: Context, attrs: AttributeSet?) :
    ...
    init {
        ...
        findViewById<View>(R.id.btn_start).setOnClickListener { v ->
            val animation = AnimationUtils.loadAnimation(v.context, R.anim.scaleanim)
            tv.startAnimation(animation)
        }
        val tvPivot50 = findViewById<TextView>(R.id.tv_pivot_50)
        findViewById<View>(R.id.btn_start_pivot_50).setOnClickListener { v ->
            val animation = AnimationUtils.loadAnimation(v.context, R.anim.scaleanim_pivot_50)
        ...
        findViewById<View>(R.id.btn_start_pivot_50_percent).setOnClickListener { v ->
            val animation =
                AnimationUtils.loadAnimation(v.context, R.anim.scaleanim_pivot_50_percent)
        ...
        findViewById<View>(R.id.btn_start_pivot_50_percent_p).setOnClickListener { v ->
            val animation =
                AnimationUtils.loadAnimation(v.context, R.anim.scaleanim_pivot_50_percent_p)
